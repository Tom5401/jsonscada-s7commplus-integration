...
- ✅ **v1.5 — TagTreeBrowser Overhaul** — Phases 16–19 (shipped 2026-03-30)
...
<details>
<summary>✅ v1.5 — TagTreeBrowser Overhaul (Phases 16–19) — SHIPPED 2026-03-30</summary>

- [x] Phase 16: Backend — listS7PlusChildNodes Endpoint + Index (1/1 plans) — completed 2026-03-30
- [x] Phase 17: Lazy Tree Loading + Boolean Display (1/1 plans) — completed 2026-03-30
- [x] Phase 18: Value Write Dialog (1/1 plans) — completed 2026-03-30
- [x] Phase 19: Non-Datablock Tags (1/1 plans) — completed 2026-03-30
