...
- [x] **Phase 10: API Cap Removal** - Remove 200-alarm limit and add MongoDB index in same change (completed 2026-03-25)
...
Plans:
- [x] 11-01-PLAN.md — Display changes: timestamp, priority, ack indicator, column reorder, page preservation
- [x] 11-02-PLAN.md — Interaction: source filter dropdown and Ack All bulk action
**UI hint**: yes
